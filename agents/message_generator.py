...
## 추가 요구사항: 작성 의도(Rationale) 포함
- 메시지를 작성할 때, **왜 이 표현과 톤을 선택했는지** 구체적인 이유를 함께 작성해주세요.
- 페르소나의 어떤 '피부 고민'이나 '감성 트리거'를 제품의 '어떤 기능'과 연결했는지 설명해야 합니다.
    ...
    "product_messages": [
        {{
            ...
            "main_message": {{
                ...
                "rationale": "작성 의도 상세 설명 (예: 고객의 '트렌드 민감성'을 자극하기 위해 '서울 잇걸'이라는 키워드를 사용했으며, 건조함 고민 해결을 위해 '밤 제형'을 강조함)"
            }},
            "alternative_1": {{
            ...
            "alternative_2": {{
                ...
                "cta": "CTA",
                "angle": "대안 2의 어필 각도",
                "rationale": "대안 2의 작성 의도"
            }}
        }}
    ],
    "overall_strategy": "여기에는 3~4문장으로 전체 캠페인 전략과 작성 의도를 적습니다. (예: ~님은 실용성을 중시하므로 가성비와 AS를 강조하는 전략을...)"
}}"""),
            ("human", """
## 페르소나 정보
- 이름: {persona_name}
